type Props = {
    titulo: string
    tipo: 'primary' | 'secundary' | 'danger' | 'verde';
...
export default function Boton(props:Props) {
    ...
    }else if(props.tipo === 'verde') {
        tipoColor = "px-4 py-2 rounded-md bg-emerald-600 text-white text-sm font-medium hover:bg-emerald-700";
    }
